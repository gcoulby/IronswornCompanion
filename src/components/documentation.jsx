  ...
  getDocumentationContent() {
    return (
      <React.Fragment>
        ...
        <p>
          Once you have added an oracle table you can edit the tables using the left hand column. Simply select an
          oracle table from the drop down box and start typing in the box below. Every line represents 1 row in the
          oracle table. For this reason, long oracles will cause a scroll bar to appear along the bottom of the text
